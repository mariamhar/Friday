	...
	class Post {
		...
		public function submitPost($body, $user_to) {
			...
			if($check_empty != "") {
				...
				//insert post
				$query = mysqli_query($this->con, "INSERT INTO posts (id,body,added_by,user_to,date_added,user_closed,deleted,likes) VALUES (NULL, '$body', '$added_by', '$user_to', '$date_added', 'no', 'no', '0')");
		...
		public function getSinglePost($post_id) {
			...
			$str = ""; // String to return
			$data_query = mysqli_query($this->con, "SELECT * FROM posts WHERE deleted='no' AND id = '$post_id' LIMIT 1");
			...
			if(mysqli_num_rows($data_query) > 0) {
				...
				if($user_logged_obj->isFriend($added_by)) {
				    ...
				    <script> // This doesn't work in Firefox
							...
							$str .= "
												<div class='status_post' onClick='javascript:toggle$id()'>
													...
													<div class='posted_by'>
														...
														$user_to &nbsp;&nbsp;&nbsp;&nbsp;$time_message $delete_button
													</div>
