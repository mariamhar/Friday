...
<html>
  <head>
    <title>Register - Friday by Notearise</title>
      ...
      <div class="login_box">
        ...
        <div id="second">
          ...
          <form action="register.php" method="POST">
            ...
            <br>
            <?php if(in_array("<span style='color:#14c800;'>You're all set! Go ahead and <a href='login.php'>login</a>!</span><br>", $error_array)) echo "<span style='color:#14c800;'>You're all set! Go ahead and <a href='login.php'>login</a>!</span><br>"; ?>
